		...
		<a-form :model="formData" layout="vertical">
			...
			<a-form-item label="Batch Size" name="batchSize">
				<a-input-number
					...
					style="width: 100%"
				/>
				<div class="parameter-description">Number of items to process in each loop iteration</div>
			</a-form-item>

			<!-- Reset Option -->
			<a-form-item name="reset">
				<a-checkbox v-model:checked="formData.reset"> Reset on new input </a-checkbox>
