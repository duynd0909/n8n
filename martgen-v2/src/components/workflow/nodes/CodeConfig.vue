<template>
  <a-form layout="vertical">
    <a-form-item label="Mode">
      ...
      >
        <a-select-option value="runOnceForAllItems">
          Run Once for All Items
        </a-select-option>
        <a-select-option value="runOnceForEachItem">
          Run Once for Each Item
        </a-select-option>
      </a-select>
      <p class="form-help-text">
        Determines how the code is executed for input items
      </p>
    </a-form-item>
    ...
    <a-form-item label="JavaScript">
      ...
      <div class="editor-help">
        <p class="help-title">
          Type <strong>$</strong> for a list of
          <strong>special vars/methods</strong>.
        </p>
        <p class="help-text">
          Debug by using <code>console.log()</code> statements and viewing their
