	...
	<a-form layout="vertical">
		<a-form-item label="Trigger Interval">
			<a-select v-model:value="formData.scheduleInterval" placeholder="Select interval">
				...
				<a-select-option value="cron">Custom (Cron)</a-select-option>
			</a-select>
		</a-form-item>
		...
		<template v-if="formData.scheduleInterval === 'cron'">
			<a-form-item label="Cron Expression (Quartz)">
				<a-input
				...
				<p class="form-help-text">
					Enter a Quartz cron expression. Format: <code>second minute hour day month weekday</code>
				</p>
				<div class="cron-examples">
					<p class="form-help-text"><strong>Examples:</strong></p>
					<ul class="cron-example-list">
						<li><code>0 0 12 * * ?</code> - Every day at 12:00 PM</li>
						<li><code>0 15 10 * * ?</code> - Every day at 10:15 AM</li>
						<li><code>0 0/5 * * * ?</code> - Every 5 minutes</li>
						<li><code>0 0 8-17 * * MON-FRI</code> - Every hour 8 AM to 5 PM on weekdays</li>
					...
					<p class="form-help-text">
						<a
							...
							target="_blank"
						>
							Learn more about Quartz Cron Expressions
						</a>
					</p>
				</div>
			</a-form-item>
...
const formData = reactive({
	...
	// Cron expression
	cronExpression: props.modelValue?.cronExpression || '',
});
