    ...
    <div class="sidebar-content">
      ...
      >
        ...
        <a-sub-menu key="projects">
          ...
          <a-menu-item key="project-1">
            <FileTextOutlined /> Data Sync Workflow
          </a-menu-item>
          <a-menu-item key="project-2">
            <FileTextOutlined /> ES to PostgreSQL
          </a-menu-item>
          <a-menu-item key="project-3">
            <FileTextOutlined /> Data Transform
          </a-menu-item>
        </a-sub-menu>
